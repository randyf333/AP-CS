...
public class LunchRoom
{
   ...
   public static int seWait = 0;
   public static int seTime;
   public static int juniorCount = 0;
   public static int juWait = 0;
   public static int juTime; 
   public static int sophCount = 0;
   public static int soWait = 0;
   public static int soTime;
   public static int freshCount = 0;
   public static int frWait = 0;
   public static int frTime;
   public static void main(String[] args)
   {
      PriorityQueue<Customer> queue = new PriorityQueue<Customer>();
      /*  write code for the simulation   */
      while(totalMinutes < TIME || !queue.isEmpty())
      {
         if(totalMinutes < TIME)
         {
            ...
            if(chance < CHANCE_OF_CUSTOMER)
            {
               ...
               {
                  seniorCount++;
               }else if(dude.getType() == "Jr")
               {
                  juniorCount++;
               }else if(dude.getType() == "So")
               {
                  sophCount++;
               }else{
                  freshCount++;
               }
               display(totalMinutes, queue);
            }else{
               display(totalMinutes, queue);
            }
         }else{
         ...
         if(!queue.isEmpty())
         {
            ...
            if(prev.getOrderTime() == 0)
            {
               if(prev.getType() == "Se")
               {
                  seTime = totalMinutes-prev.getArrivalTime()+1;
                  if(seTime > seWait)
                  {
                     seWait = seTime;
                  }
               }else if(prev.getType() == "Jr")
               {
                  juTime = totalMinutes-prev.getArrivalTime()+1;
                  if(juTime > juWait)
                  {
                     juWait = juTime;
                  }
               }else if(prev.getType() == "So")
               {
                  soTime = totalMinutes-prev.getArrivalTime()+1;
                  if(soTime > soWait)
                  {
                     soWait = soTime;
                  }
               }else{
                  frTime = totalMinutes-prev.getArrivalTime()+1;
                  if(frTime > frWait)
                  {
                     frWait = frTime;
                  }
      ...
      /* report the data  */
      System.out.println("Senior"+"\t\t"+seniorCount+"\t\t\t"+seWait+"\t\t"+calculateSeniorAverage());
      System.out.println("Junior"+"\t\t"+juniorCount+"\t\t\t"+juWait+"\t\t"+calculateJuniorAverage());
      System.out.println("Sophomor" + "\t\t" + sophCount+"\t\t\t"+soWait+"\t\t"+calculateSophmoreAverage());
      System.out.println("Freshman"+"\t\t"+freshCount+"\t\t\t"+frWait+"\t\t"+calculateFreshmanAverage());
   }
   ...
   public static double calculateSeniorAverage()
   {
      return (int)(1.0 * totalMinutes/seniorCount * 10)/10.0;
   }
   public static double calculateJuniorAverage()
   {
      return (int)(1.0 * totalMinutes/juniorCount * 10)/10.0;
   }
   public static double calculateSophmoreAverage()
   {
      return (int)(1.0 * totalMinutes/sophCount * 10)/10.0;
   }
   public static double calculateFreshmanAverage()
   {
      return (int)(1.0 * totalMinutes/freshCount * 10)/10.0;
   }
